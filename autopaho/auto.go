...
import (
	...
	"github.com/adibaulia/paho.golang/autopaho/queue/memory"
...
// AutoPaho is a wrapper around github.com/adibaulia/paho.golang that simplifies the connection process; it automates
...
// requirements differ then please consider using github.com/adibaulia/paho.golang directly (perhaps using the
		...
		for {
			...
			for {
				...
				if errors.Is(err, queue.ErrEmpty) {
					...
					// see https://github.com/adibaulia/paho.golang/issues/234
